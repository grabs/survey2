...
$PAGE->set_url('/mod/survey/item/captcha/print_captcha.php', array('id'=>$id));
...
if (!isset($SESSION->survey->item->captcha)) {
    print_error('captchanotset', 'survey');
}

$height = 40;
$charcount = $SESSION->survey->item->captcha->charcount;
...
$SESSION->survey->item->captcha->checkchar = $checkchar;
