...
class survey_item_info extends survey_item_base {
    protected $type = "info";
    ...
    public function build_editform($item, $survey, $cm) {
        ...
        //build the form
        $this->item_form = new survey_info_form('edit_item.php',
                                                  array('item'=>$item,
                                                  'common'=>$commonparams,
    ...
    public function print_item_preview($item) {
        ...
        if ($item->survey) {
            $courseid = $DB->get_field('survey', 'course', array('id'=>$item->survey));
        ...
        echo '<span class="survey_item_info">'.$itemshowvalue.'</span>';
        echo '</div>';
    }
    ...
    public function print_item_complete($item, $value = '', $highlightrequire = false) {
        ...
        $survey = $DB->get_record('survey', array('id'=>$item->survey));
