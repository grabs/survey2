...
class mod_survey_use_templ_form extends moodleform {
    public function definition() {
        ...
        // visible elements
        $mform->addElement('radio', 'deleteolditems', '1)', get_string('delete_old_items', 'survey'), 1);
        $mform->addElement('radio', 'deleteolditems', '2)', get_string('append_new_items', 'survey'), 0);
