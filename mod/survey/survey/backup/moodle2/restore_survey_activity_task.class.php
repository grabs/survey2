...
class restore_survey_activity_task extends restore_activity_task {
    ...
    static public function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('survey', array('intro', 'site_after_submit', 'page_after_submit'), 'survey');
        $contents[] = new restore_decode_content('survey_item', array('presentation'), 'survey_item');
        $contents[] = new restore_decode_content('survey_value', array('value'), 'survey_value');
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('SURVEYANALYSISBYID', '/mod/survey/analysis.php?id=$1', 'course_module');
        $rules[] = new restore_decode_rule('SURVEYSHOWENTRIESBYID', '/mod/survey/show_entries.php?id=$1', 'course_module');
    ...
    static public function define_restore_log_rules() {
        ...
        $rules[] = new restore_log_rule('survey', 'startcomplete', 'view.php?id={course_module}', '{survey}');
