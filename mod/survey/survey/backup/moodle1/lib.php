...
/**
 * Survey module conversion handler
 */
class moodle1_mod_survey_handler extends moodle1_mod_handler {
    ...
    public function get_paths() {
        return array(
            ...
            new convert_path(
                'survey_item', '/MOODLE_BACKUP/COURSE/MODULES/MOD/SURVEY/ITEMS/ITEM',
                array (
                    'newfields' => array(
                        'label' => '',
                        'options' => '',
    ...
    /**
     * This is executed every time we have one /MOODLE_BACKUP/COURSE/MODULES/MOD/SURVEY/ITEMS/ITEM
     * data available
     */
    public function process_survey_item($data) {
