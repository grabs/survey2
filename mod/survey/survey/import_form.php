...
class survey_import_form extends moodleform {
    public function definition() {
        ...
        $strdeleteolditmes = get_string('delete_old_items', 'survey').
                             ' ('.get_string('oldvalueswillbedeleted', 'survey').')';

        $strnodeleteolditmes = get_string('append_new_items', 'survey').
                               ' ('.get_string('oldvaluespreserved', 'survey').')';
