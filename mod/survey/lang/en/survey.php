...
$string['cannotmapsurvey'] = 'Database problem, unable to map survey to course';
...
$string['completed_surveys'] = 'Submitted answers';
$string['complete_the_form'] = 'Answer the questions...';
$string['completionsubmit'] = 'View as completed if the survey is submitted';
$string['configallowfullanonymous'] = 'If this option is set yes so the survey can be completed without any preceding logon. It only affects surveys on the homepage.';
...
$string['drop_survey'] = 'Remove from this course';
...
$string['emailnotification_help'] = 'If enabled, administrators receive email notification of survey submissions.';
$string['emailteachermail'] = '{$a->username} has completed survey activity : \'{$a->survey}\'

You can view it here:

{$a->url}';
$string['emailteachermailhtml'] = '{$a->username} has completed survey activity : <i>\'{$a->survey}\'</i><br /><br />
...
$string['surveyclose'] = 'Close the survey at';
$string['surveycloses'] = 'Survey closes';
$string['survey:complete'] = 'Complete a survey';
$string['survey:createprivatetemplate'] = 'Create private template';
$string['survey:createpublictemplate'] = 'Create public template';
$string['survey:deletesubmissions'] = 'Delete completed submissions';
$string['survey:deletetemplate'] = 'Delete template';
$string['survey:edititems'] = 'Edit items';
$string['survey_is_not_for_anonymous'] = 'survey is not for anonymous';
$string['survey_is_not_open'] = 'The survey is not open';
$string['survey:mapcourse'] = 'Map courses to global surveys';
$string['surveyopen'] = 'Open the survey at';
$string['surveyopens'] = 'Survey opens';
$string['survey_options'] = 'Survey options';
$string['survey:receivemail'] = 'Receive email notification';
$string['survey:view'] = 'View a survey';
$string['survey:viewanalysepage'] = 'View the analysis page after submit';
$string['survey:viewreports'] = 'View reports';
$string['file'] = 'File';
$string['filter_by_course'] = 'Filter by course';
$string['handling_error'] = 'Error occurred in survey module action handling';
...
$string['chosen_survey_response'] = 'chosen survey response';
...
To keep the survey anonymous, a minimum of 2 responses must be done.';
...
$string['mapcourseinfo'] = 'This is a site-wide survey that is available to all courses using the survey block. You can however limit the courses to which it will appear by mapping them. Search the course and map it to this survey.';
$string['mapcoursenone'] = 'No courses mapped. Survey available to all courses';
$string['mapcourse'] = 'Map survey to courses';
$string['mapcourse_help'] = 'By default, survey forms created on your homepage are available site-wide
and will appear in all courses using the survey block. You can force the survey form to appear by making it a sticky block or limit the courses in which a survey form will appear by mapping it to specific courses.';
$string['mapcourses'] = 'Map survey to courses';
$string['mapcourses_help'] = 'Once you have selected the relevant course(s) from your search,
you can associate them with this survey using map course(s). Multiple courses may be selected by holding down the Apple or Ctrl key whilst clicking on the course names. A course may be disassociated from a survey at any time.';
...
$string['messageprovider:message'] = 'Survey reminder';
$string['messageprovider:submission'] = 'Survey notifications';
$string['mode'] = 'Mode';
$string['modulename'] = 'Survey';
$string['modulename_help'] = 'The survey modules enables custom surveys to be created.';
$string['modulenameplural'] = 'Survey';
...
$string['multiplesubmit_help'] = 'If enabled for anonymous surveys, users can submit survey an unlimited number of times.';
$string['name'] = 'Name';
...
$string['notavailable'] = 'this survey is not available';
...
$string['only_one_captcha_allowed'] = 'Only one captcha is allowed in a survey';
...
$string['ready_surveys'] = 'Ready surveys';
$string['relateditemsdeleted'] = 'All your user\'s responses for this question will also be deleted';
$string['required'] = 'Required';
$string['resetting_data'] = 'Reset survey responses';
$string['resetting_surveys'] = 'Resetting surveys';
...
$string['searchcourses_help'] = 'Search for the code or name of the course(s) that you wish to associate with this survey.';
...
$string['this_survey_is_already_submitted'] = 'You\'ve already completed this activity.';
$string['timeclose'] = 'Time to close';
$string['timeclose_help'] = 'You can specify times when the survey is accessible for people to answer the questions. If the checkbox is not ticked there is no limit defined.';
$string['timeopen'] = 'Time to open';
$string['timeopen_help'] = 'You can specify times when the survey is accessible for people to answer the questions. If the checkbox is not ticked there is no limit defined.';
...
$string['url_for_continue_help'] = 'By default after a survey is submitted the target of the continue button is the course page. You can define here another target URL for this continue button.';
...
$string['viewcompleted'] = 'completed surveys';
$string['viewcompleted_help'] = 'You may view completed survey forms, searchable by course and/or by question.
Survey responses may be exported to Excel.';
