...
class backup_survey_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        if ($userinfo) {
            ...
            $value->set_source_table('survey_value', array('completed' => backup::VAR_PARENTID));

            $tracking->set_source_table('survey_tracking', array('survey' => backup::VAR_PARENTID));
        }
        ...
        $item->annotate_files('mod_survey', 'item', 'id');
