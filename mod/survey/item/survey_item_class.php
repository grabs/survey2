...
abstract class survey_item_base {
    protected $type;
    ...
    abstract public function build_editform($item, $survey, $cm);
     ...
     * @param object $item the db-object from survey_item
    ...
    /**
     * @param $item the db-object from survey_item
     * @param string $itemnr
     * @param integer $groupid
     * @param integer $courseid
    ...
    /**
     * @param object $item the db-object from survey_item
     * @param string $value a item-related value from survey_values
     * @return string
     */
...
class survey_item_pagebreak extends survey_item_base {
